...
public class Tub extends RoomElement implements Prototype {
    ...
    public Tub(DraftNode parent, double xRatio, double yRatio, int rotateRatio) {
        super("Tub" + counter, parent, xRatio, yRatio, rotateRatio);
        this.name = "Tub" + counter;
        ++counter;
    }
    ...
    @Override
    public Tub clone() {
        Tub cloned = new Tub(getParent(), getXRatio(), getYRatio(), getRotateRatio());
        cloned.setY(getY());
        cloned.setX(getX() + 20);
