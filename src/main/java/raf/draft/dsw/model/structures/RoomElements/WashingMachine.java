...
public class WashingMachine extends RoomElement implements Prototype {
    ...
    public WashingMachine(DraftNode parent, double xRatio, double yRatio, int rotateRatio) {
        super("WashingMachine" + counter, parent, xRatio, yRatio, rotateRatio);
        this.name = "WashingMachine" + counter;
        ++counter;
    }
    ...
    @Override
    public WashingMachine clone() {
        WashingMachine cloned = new WashingMachine(getParent(), getXRatio(), getYRatio(), getRotateRatio());
        cloned.setY(getY());
        cloned.setX(getX() + 20);
    ...
    public static void setCounter(int counter) {
        WashingMachine.counter = counter;
    }}
